...
class npl():
    ...
    def __init__(self, X, B, m, p, l, model, model_name = 'gaussian', batch_size=200, x0=None, Nstep=1000):
        self.model = model
        self.B = B  
        self.m = m  
        self.p = p  
    ...
    def draw_single_sample(self, weights):
        ...
        if self.model_name == 'toggle_switch':
            ...
            theta_j = self.minimise_MMD(self.X, weights, batch_size=self.batch_size, Nstep=self.Nstep)
    ...
    def minimise_MMD(self, data, weights, Nstep=1000, eta=0.1, batch_size=None):
        ...
        for i in range(Nstep):            
            ...
            # update  
            value, opt_state, key2 = step(next(itercount), opt_state, batches, key2)
